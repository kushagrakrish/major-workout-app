    ...
    <div>
      <Layout>
        ...
        <div className='w-full h-screen bg-zinc-200 flex flex-col justify-between'>
          <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
            <div className='flex flex-col justify-center md:items-start w-full px-2 drop-shadow-lg'>
              ...
              <p className='py-5 text-2xl'>
                Your goals. Your customised fitness program. Your habit tracker.
                Now all in one place. We understand that every person’s journey
                is different and each person wants to set their own pace for
                their fitness journey!
              </p>
              <p className='py-5 text-2xl'>
        ...
        <div className='px-20 w-full h-[900px] bg-zinc-200 justify-center'>
          ...
          <p className='pt-5 text-2xl px-7'>
            Use our free fitness tools & trackers to take your journey to the
            next level!
          </p>
          <div className='grid grid-cols-1 lg:grid-cols-4 relative gap-x-8 gap-y-5 px-4 py-2 sm:pt-20 text-black'>
            <div className='bg-white rounded-xl shadow-2xl'>
              <div className='p-8 pt-0'>
                ...
                <p className='text-gray-600 text-l mb-8'>
                  Macronutrients are the nutrients that our body needs in large
                  needs in large quantities including fats, protiens, carbs,
                  water and fibre
                </p>
            ...
            <div className='bg-white rounded-xl shadow-2xl'>
              <div className='p-8 pt-0'>
                ...
                <p className='text-gray-600 text-l mb-12'>
                  Your basic metabolic rate(BMR) is the number of calories our
                  body needs them to sustain itself if you do absolutely nothing
                  all day.
                </p>
                <div className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-4/5 text-center'>
                  <a href='https://www.calculator.net/bmr-calculator.html'>
                    Calculate Now
                  </a>
                </div>
              </div>
            ...
            <div className='bg-white rounded-xl shadow-2xl'>
              <div className='p-8 pt-0'>
                ...
                <div className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-4/5 text-center'>
                  <a href='https://www.bodybuilding.com/fun/other7.html'>
                    Calculate Now
                  </a>
                </div>
              </div>
            ...
            <div className='bg-white rounded-xl shadow-2xl'>
              <div className='p-8 pt-0'>
                ...
                <p className='text-gray-600 text-l mb-12'>
                  Body fat percentage is a key indicator of good health. A high
                  body fat % might put you at a greater risk of lifestyle
                  diseases.
                </p>
                <div className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-4/5 text-center'>
                  <a href='https://www.calculator.net/body-fat-calculator.html'>
                    Calculate Now
                  </a>
                </div>
              </div>
