        ...
        <div className='bg-zinc-100'>
          ...
          <div className='flex flex-col w-[80%] mx-auto my-0 gap-10'>
            <div>
              ...
              <div className='list-none flex flex-col gap-7'>
                <li className='bg-blue-100 text-[20px] text-gray-500 font-medium h-9 '>
                  <span className='ml-5'>1.</span> Lay flat on the bench with
                  your feet on the ground. With straight arms unrack the bar.
                </li>
                <li className='bg-blue-100 text-[20px] text-gray-500 font-medium h-9 '>
                  <span className='ml-5'>2.</span>Lower the bar to your mid
                  chest .
                </li>
                <li className='bg-blue-100 text-[20px] text-gray-500 font-medium h-9 '>
            ...
            <div>
              ...
              <div className='list-none flex flex-col gap-7'>
                <li className='bg-blue-100 text-[20px] text-gray-500 font-medium h-9 '>
                  <span className='ml-5'>1.</span> Raise the bench to a 30
                  degree angle.
                </li>
                <li className='bg-blue-100 text-[20px] text-gray-500 font-medium h-9 '>
            ...
            <div>
              ...
              <div className='list-none flex flex-col gap-7'>
                <li className='bg-blue-100 text-[20px] text-gray-500 font-medium h-9 '>
                  <span className='ml-5'>1.</span> Place your hands firmly on
                  the ground, directly under shoulders.
                </li>
                <li className='bg-blue-100 text-[20px] text-gray-500 font-medium h-9 '>
                  <span className='ml-5'>2.</span>Flatten your back so your
                  entire body is straight and slowly lower your body
                </li>
                <li className='bg-blue-100 text-[20px] text-gray-500 font-medium h-9 '>
                ...
                <li className='bg-blue-100 text-[20px] text-gray-500 font-medium h-9 '>
                  <span className='ml-5'>4.</span> Exhale as you push back to
            ...
            <div>
              ...
              <div className='list-none flex flex-col gap-7'>
                <li className='bg-blue-100 text-[20px] text-gray-500 font-medium h-9 '>
                  <span className='ml-5'>1.</span> Use a handle attachment set
                ...
                <li className='bg-blue-100 text-[20px] text-gray-500 font-medium h-9 '>
                  <span className='ml-5'>3.</span> Walk a few steps forward.
                  Then press the weight forward. From there, your shoulders
                  should horizontally abduct and adduct while your elbows stay
                  in a fixed position.
                </li>
                <h1 className='text-[28px] font-semibold text-gray-700'>
                  Video Tutorial
            ...
            <div>
              ...
              <div className='list-none flex flex-col gap-7'>
                <li className='bg-blue-100 text-[20px] text-gray-500 font-medium h-9 '>
                  <span className='ml-5'>1.</span> Lay flat on the bench and
                  place your feet on the ground.
                </li>
                <li className='bg-blue-100 text-[20px] text-gray-500 font-medium h-9 '>
                  <span className='ml-5'>2.</span>Begin the exercise with the
                  dumbbells held together above your chest, elbows slightly
                  bent.
                </li>
                <li className='bg-blue-100 text-[20px] text-gray-500 font-medium h-9 '>
