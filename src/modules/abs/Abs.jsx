...
import sampleAbs from "../../assests/sampleAbs.pdf";
    ...
    const fetchAbs = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5000/api/exercise/abs"
        );
          ...
          <div className='flex flex-col w-[80%] mx-auto my-0 gap-10'>
            ...
            <div>
              <h1 className='text-[26px] font-semibold text-blue-500 mt-2 mb-2'>
                Here is sample Abs workout!
              </h1>
              <h3 className='text-[18px] font-medium text-gray-700 mb-8'>
                Try this in your next workout session
              </h3>
              <Button colorScheme={"blue"} variant={"solid"} href={sampleAbs}>
                <a href={sampleAbs} download={sampleAbs}>
                  Download here
                </a>
              </Button>
            </div>
